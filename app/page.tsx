        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-8 grid grid-cols-1 md:grid-cols-3 gap-8 pb-8">
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center gap-3 text-slate-400">
              ...
              <a href={`https://wa.me/${storeConfig?.whatsapp_number}`} target="_blank" rel="noreferrer" className="p-2 bg-slate-900 hover:bg-indigo-600 rounded-xl hover:text-white transition shadow-md"><Phone className="w-4 h-4" /></a>
            </div>
